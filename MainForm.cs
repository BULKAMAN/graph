...
namespace Graph
{
    public partial class MainForm : Form
    {
        ...
        private void DrawAxis(int offset)
        {
            ...
            for (int i = 1; i < barCount * 2; i++)
            {
                graphics.DrawLine(axisPen, new Point(map.Width/2 + offset * gridScale - 5, i * gridScale), new Point(map.Width/2 + offset * gridScale + 5, i * gridScale));
                graphics.DrawLine(axisPen, new Point(i * gridScale, map.Height/2 - 5), new Point(i * gridScale, map.Height/2 + 5));
            }
